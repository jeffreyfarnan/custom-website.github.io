// Step 1
// Click on 'Large Print' adds the large class to the <body> tag
...
// Step 3
 ...
 //    $('body').removeClass('narrow');
 //    $('body').removeClass('large');
     // Remove highlight from every button inside the style switcher
...
// Step 4 -Generalising the statements makes it more efficient
 //$(document).ready(function() {
 //  $('#switcher-default').bind('click', function() {
...
// Step 6 Put removeClass into our general button click handler
 //$(document).ready(function() {
 //  $('#switcher .button').bind('click', function() {
 //    $('body').removeClass();
 //    $('#switcher .button').removeClass('selected');
...
// Step 7 Can get rid of specific handlers entirely
 //$(document).ready(function() {
 //  $('#switcher .button').bind('click', function() {
 //    $('body').removeClass();
...
// Step 8 - Can be written using a click instead of bind
// $(document).ready(function() {
...
// Step 9 - Showing and hiding the style switcher
// $(document).ready(function() {
